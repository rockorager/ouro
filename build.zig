...
pub fn build(b: *std.Build) void {
    ...
    generate_core_protocol.addFileArg(wayland_protocols.path("staging/ext-background-effect/ext-background-effect-v1.xml"));
    generate_core_protocol.addFileArg(wayland_protocols.path("staging/pointer-warp/pointer-warp-v1.xml"));
    generate_core_protocol.addFileArg(wayland_protocols.path("staging/security-context/security-context-v1.xml"));
    ...
    generate_core_protocol.addFileArg(wayland_protocols.path("staging/xdg-session-management/xdg-session-management-v1.xml"));
    ...
    generate_core_protocol.addFileArg(wlr_protocols.path("unstable/wlr-virtual-pointer-unstable-v1.xml"));
    generate_core_protocol.addFileArg(wlr_protocols.path("unstable/wlr-screencopy-unstable-v1.xml"));
    ...
    generate_xdg_protocol.addFileArg(wayland_protocols.path("staging/ext-background-effect/ext-background-effect-v1.xml"));
    generate_xdg_protocol.addFileArg(wayland_protocols.path("staging/pointer-warp/pointer-warp-v1.xml"));
    generate_xdg_protocol.addFileArg(wayland_protocols.path("staging/security-context/security-context-v1.xml"));
    ...
    generate_xdg_protocol.addFileArg(wayland_protocols.path("staging/xdg-session-management/xdg-session-management-v1.xml"));
    ...
    generate_xdg_protocol.addFileArg(wlr_protocols.path("unstable/wlr-virtual-pointer-unstable-v1.xml"));
    generate_xdg_protocol.addFileArg(wlr_protocols.path("unstable/wlr-screencopy-unstable-v1.xml"));
